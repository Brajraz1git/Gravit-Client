...
export default function EventsList() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-linear-to-b from-black via-gray-900 to-black flex items-center justify-center pt-20">
        <div className="text-center">
          <div className="relative">
            <div className="inline-block animate-spin rounded-full h-16 w-16 border-b-4 border-t-4 border-yellow-200 mb-4"></div>
            <div className="absolute inset-0 inline-block animate-ping rounded-full h-16 w-16 border border-yellow-400 opacity-20"></div>
          </div>
  ...
  return (
    <main className="min-h-screen bg-linear-to-b from-black via-gray-900 to-black py-12 pt-24 px-4 sm:px-6 lg:px-8">
      <div className="container mx-auto max-w-7xl">
        {/* Header Section */}
        <div className="text-center mb-12">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-medium mb-4 bg-yellow-200 bg-clip-text text-transparent animate-pulse">
            Explore All Events
          </h1>
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            Find and book tickets for the exciting events
          </p>
        ...
        <div className="bg-gray-800/50 backdrop-blur-lg rounded-2xl border border-gray-700/50 p-6 md:p-8 mb-10 shadow-2xl hover:border-yellow-500/50 transition-all duration-300">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
            <div className="relative">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3.5 pl-11 bg-gray-900/80 border-2 border-gray-700 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-yellow-500 focus:ring-2 focus:ring-yellow-500/20 transition-all duration-200 hover:border-gray-600"
                />
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full px-4 py-3.5 bg-gray-900/80 border-2 border-gray-700 rounded-xl text-white focus:outline-none focus:border-yellow-500 focus:ring-2 focus:ring-yellow-500/20 transition-all duration-200 hover:border-gray-600 cursor-pointer"
              />
            </div>
            <div className="relative">
              <label className="text-sm font-semibold text-gray-300 mb-3 flex items-center gap-2">
              ...
              <div className="relative">
                <select
                  ...
                  className="w-full px-4 py-3.5 pr-10 bg-gray-900/80 border-2 border-gray-700 rounded-xl text-white focus:outline-none focus:border-yellow-500 focus:ring-2 focus:ring-yellow-500/20 transition-all duration-200 hover:border-gray-600 appearance-none cursor-pointer"
                >
        ...
        {filteredEvents.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-20 animate-fade-in">
            <div className="bg-linear-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-lg rounded-3xl shadow-2xl border border-gray-700/50 p-12 max-w-md text-center hover:border-yellow-500/30 transition-all duration-300">
              <svg 
              ...
              <button
                onClick={load}
                className="px-8 py-3.5 bg-yellow-200 hover:from-yellow-700 hover:to-pink-700 text-black rounded-xl transition-all font-semibold shadow-lg hover:shadow-yellow-500/50 hover:scale-105 flex items-center gap-2 mx-auto"
              >
