...
export default function EventDetail() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-linear-to-br from-indigo-50 via-purple-50 to-pink-50 flex items-center justify-center pt-20">
  ...
  return (
    <main className="min-h-screen bg-linear-to-br from-indigo-50 via-purple-50 to-pink-50 pt-20 pb-16">
      {/* Back Button */}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="bg-linear-to-br from-indigo-600 via-purple-600 to-pink-600 rounded-t-2xl p-6 text-white text-center">
