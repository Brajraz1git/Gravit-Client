...
const Button = ({ 
  ...
  const variantStyles = {
    primary: 'bg-primary text-white hover:bg-primary3 focus:ring-primary2/50 shadow-lg hover:shadow-blue-500/50',
    ghost: 'border-2 border-muted text-deep hover:border-blue-600 hover:text-blue-600 focus:ring-blue-600/20',
  };
