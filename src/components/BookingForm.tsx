  ...
  return (
    <form onSubmit={onSubmit} className="space-y-4">
      ...
      <motion.button
        ...
        className="w-full bg-linear-to-r from-green-600 to-green-700 text-white rounded-lg px-4 py-4 disabled:opacity-60 disabled:cursor-not-allowed hover:from-green-700 hover:to-green-800 transition font-bold text-lg shadow-lg hover:shadow-xl"
      >
        {loading ? (
