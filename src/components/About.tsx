...
const SummitraCountdown: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-transparent flex items-center justify-center px-4 py-8 sm:px-6 sm:py-10 md:p-12 lg:p-16">
      <TinyShootingStars/>
      <div className="max-w-6xl w-full">
        ...
        >
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl text-gray-300 leading-relaxed">
            Join us for an unforgettable seminar featuring{' '}
            <span className="text-purple-400 font-semibold">Zakir Khan</span> , one of India's most loved storytellers and comedians. {' '}
            <span className="text-gray-500">
              Experience an evening of insightful conversations, relatable stories, and real-life lessons that inspire, entertain, and connect.
            </span>
          </p>
        </motion.div>
